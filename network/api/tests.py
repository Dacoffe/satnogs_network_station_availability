...
class StationViewApiTest(TestCase):
    ...
    def test_station_view_api(self):
        ...
        station_serialized = {
            ...
            'horizon_hard_limit': self.station.horizon_hard_limit,
            'min_culmination': self.station.min_culmination,
            'min_culmination_hard_limit': self.station.min_culmination_hard_limit,
