...
def alter_advanced_configuration(apps, schema_editor):
...
def reverse_alter_advanced_configuration(apps, schema_editor):
    StationConfigurationSchema = apps.get_model('base', 'StationConfigurationSchema')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(alter_advanced_configuration, reverse_alter_advanced_configuration),
    ]
